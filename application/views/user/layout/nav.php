...
<li class="hvr-bounce-to-bottom"><a href="<?php echo base_url('artikel') ?>">Artikel</a></li>

<!--   <li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Kategori<span class="caret"></span></a>
      <ul class="dropdown-menu">
...
<li class="hvr-bounce-to-bottom"><a href="<?php echo base_url('login') ?>">Login</a></li>

<!-- <li class="hvr-bounce-to-bottom"><a href="<?php echo base_url('login/logout') ?>">Logout</a></li> -->

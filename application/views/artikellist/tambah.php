...
// Form
echo form_open_multipart('artikel/tambah');
?>

<div class="col-md-8">
<div class="form-group form-group-lg">
<!-- <label>ID</label> -->
<input type="hidden" name="id_user" placeholder="1" value="<?php echo set_value('1') ?>" required class="form-control" readonly>
</div>
</div>
...
<a href="<?php echo base_url('artikel') ?>" class="btn btn-primary btn-lg">Kembali</a>
</div>
